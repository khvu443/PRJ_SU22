            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img style="height:230px" src="./img/vietnamese_food.jpg" alt="vienamese_combo">
                            </div>
                            <div class="shop-body">
                                <h3>VietNamese's Food<br>Combo</h3>
                                <a href="Work_In_Progress.jsp" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a> <!-- taọ thêm 1 jsp cho combo -->
                            </div>
                        </div>
                    </div>
                    <!-- /shop -->
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img style="height:230px" src="./img/hotdealCombo.jpg" alt="hotdeal_combo">
                            </div>
                            <div class="shop-body">
                                <h3>Hot Deal<br>Combo</h3>
                                <a href="Work_In_Progress.jsp" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a> <!-- taọ thêm 1 jsp cho combo -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img style="height:230px" src="./img/italian_combo.jpeg" alt="italian_combo">
                            </div>
                            <div class="shop-body">
                                <h3>New Italy's food<br>Combo</h3>
                                <a href="Work_In_Progress.jsp" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a> <!-- taọ thêm 1 jsp cho combo -->
                            </div>
                        </div>
                    </div>
