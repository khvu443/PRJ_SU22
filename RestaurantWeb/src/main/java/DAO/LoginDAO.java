...
public class LoginDAO {
    ...
    public void NewAcc(String id, String usernamme, String password, String fullname, String roleId) {
    ...
    public void updateAcc(String id, String usernamme, String password, String fullname, String roleId) {
        String query = "update account set Username = ?, Pass= ?,Fullname= ?, RoleID=?  where accID= ?";
        try {
            conn = new DBUtils().makeConnection();
            ps = conn.prepareStatement(query);
