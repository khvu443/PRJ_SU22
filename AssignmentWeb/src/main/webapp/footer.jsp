                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <p>This web is demo for assigment</p>
                        ...
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <ul class="footer-links">
                                    <li><a href="#hot-deal">Big Sale</a></li>
                                    <%
                                        GameDAO dao = new GameDAO();
                                        List<category> cl = dao.getAllCategory();
                                    %>
                                    <% for(category c : cl) {%>
                                        <li><a href="StoreCategoryServlet?page=1&cid=<%= c.getCategoryID() %>"><%= c.getCategoryName() %></a></li>
                                    <%}%>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <ul class="footer-links">
                                    <li><a href="UpdateAccount?AID=${user.accID}">Manager Account</a></li>
