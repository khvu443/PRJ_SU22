                                ...
                                <div>
                                    <table class="table table-primary table-bordered border-light table-hover">
                                        ...
                                        <tbody class="table-light">
                                            <c:set var="u" value="${accl}" scope="session"/>
                                                ...
                                                <c:if test="${ul.accID != NAME.accID}">
                                                    <tr>
                                                        ...
                                                        <%
                                                            ...
                                                            List<RoleDetail> rl = logd.getAllRole();
                                                            request.setAttribute("role", rl);
                                                        %>

                                                        <c:forEach items="${role}" var="role">
                                                            <c:if test="${role.roleID == ul.roleID}">
                            ...
                            <div class="col-lg">
                                <div>
                                    <table class="table table-primary table-bordered border-light table-hover">
                                        ...
                                        <tbody>
                                            <c:set var="p" value="${bol}" scope="session"/>
                                            <c:forEach items="${p}" var="order">
                                                <tr>
